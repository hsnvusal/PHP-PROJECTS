<div class="list-group">
    <a href="{{route('yonetim.anasayfa')}}" class="list-group-item">
        <span class="fa fa-fw fa-dashboard"></span> Giris Sayfasi</a>
    <a href="#" class="list-group-item">
        <span class="fa fa-fw fa-dashboard"></span> Urunler
        <span class="badge badge-dark badge-pill pull-right">14</span>
    </a>
    <a href="{{route('yonetim.kategori')}}" class="list-group-item collapsed" data-target="#submenu1" data-toggle="collapse" data-parent="#sidebar"><span class="fa fa-fw fa-dashboard"></span> Kategoriler<span class="caret arrow"></span></a>
