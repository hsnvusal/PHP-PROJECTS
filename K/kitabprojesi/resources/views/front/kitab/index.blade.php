                    ...
                    <div class="sngl-top">
                        ...
                        <div class="col-md-9 single-top-right">
                            <div class="single-para simpleCart_shelfItem">
                                ...
                                <div class="available">
                                    <ul>
                                        <li class="size-in">Kategori: {{\App\Models\Kategoriler::getField($data[0]['kategoriid'],'name')}}</li>
                                        <li>Yayin Evi: {{\App\Models\YayinEvi::getField($data[0]['yayineviid'],'name')}} </li>
                                ...
                                <a href="{{route('basket.add',['id'=>$data[0]['id']])}}" class="add-cart item_add">SEBETE EKLE</a>
